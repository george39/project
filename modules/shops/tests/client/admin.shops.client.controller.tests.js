  ...
  describe('Shops Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (
        ...
        // Set POST response
        $httpBackend
          .expectPOST('/api/shops', sampleShopPostData)
          .respond(mockShop);
        ...
        expect(Notification.success).toHaveBeenCalledWith({
          message: '<i class="fas fa-check"></i> Shop saved successfully!'
        });
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({
          message: errorMessage,
          title: '<i class="fas fa-trash-alt"></i> Shop save error!'
        });
      });
    });
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the shop and redirect to shops', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({
          message: '<i class="fas fa-check"></i> Shop deleted successfully!'
        });
        expect($state.go).toHaveBeenCalledWith('admin.shops.list');
      });
