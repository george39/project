...
describe('Shop CRUD tests', function () {
  ...
  it('should be able to get a list of shops if not signed in', function (done) {
    ...
    shopObj.save(function () {
      // Request shops
      agent.get('/api/shops').end(function (req, res) {
        // Set assertion
  ...
  it('should be able to get a single shop if not signed in', function (done) {
    ...
    // Save the shop
    shopObj.save(function () {
      agent.get('/api/shops/' + shopObj._id).end(function (req, res) {
        // Set assertion
  ...
  it('should return proper error for single shop with an invalid Id, if not signed in', function (done) {
    ...
    agent.get('/api/shops/test').end(function (req, res) {
      // Set assertion
  ...
  it('should return proper error for single shop which doesnt exist, if not signed in', function (done) {
    ...
    agent.get('/api/shops/559e9cd815f80b4c256a8f41').end(function (req, res) {
      // Set assertion
      res.body.should.be
        .instanceof(Object)
        .and.have.property('message', 'No shop with that identifier has been found');
              ...
              orphan.remove(function () {
                ...
                agent
                  ...
                  .end(function (err, res) {
                    ...
                    // Get the shop
                    agent
                      .get('/api/shops/' + shopSaveRes.body._id)
                      .expect(200)
  ...
  afterEach(function (done) {
    Shop.remove().exec().then(User.remove().exec()).then(done()).catch(done);
  });
});
