(function () {
  ...
  describe('Admin Shippers List Controller Tests', function () {
    // Initialize global variables
    var ShippersAdminListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      $httpBackend
        .whenGET('/modules/shippers/client/views/list-shippers.client.view.html')
        .respond(200, '');
      ...
      ShippersAdminListController = $controller('ShippersAdminListController as vm', {
        $scope: $scope
      });
