(function () {
  ...
  describe('Features Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleFeaturePostData = new FeaturesService({
          title: 'An Feature about MEAN',
          content: 'MEAN rocks!'
        });

        $scope.vm.feature = sampleFeaturePostData;
      });
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (
        ...
        // Set POST response
        $httpBackend
          .expectPOST('/api/features', sampleFeaturePostData)
          .respond(mockFeature);
        ...
        expect(Notification.success).toHaveBeenCalledWith({
          message: '<i class="fas fa-check"></i> Feature saved successfully!'
        });
        // Test URL redirection after the feature was created
        expect($state.go).toHaveBeenCalledWith('admin.features.list');
      }));
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({
          message: errorMessage,
          title: '<i class="fas fa-trash-alt"></i> Feature save error!'
        });
      });
    });
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.feature = mockFeature;
      });

      it('should update a valid feature', inject(function (FeaturesService) {
        // Set PUT response
      ...
      it('should  call Notification.error if error', inject(function (FeaturesService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the feature and redirect to features', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({
          message: '<i class="fas fa-check"></i> Feature deleted successfully!'
        });
        expect($state.go).toHaveBeenCalledWith('admin.features.list');
      });

      it('should should not delete the feature and not redirect', function () {
