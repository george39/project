(function () {
  ...
  describe('Admin DiscountLists List Controller Tests', function () {
    // Initialize global variables
    var DiscountListsAdminListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      $httpBackend
        .whenGET('/modules/discountLists/client/views/list-discountLists.client.view.html')
        .respond(200, '');
      ...
      DiscountListsAdminListController = $controller('DiscountListsAdminListController as vm', {
        $scope: $scope
      });
