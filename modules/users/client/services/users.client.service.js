(function () {
  ...
  function UsersService($resource) {
    ...
    angular.extend(Users, {
      ...
      shopSignup: function (credentials) {
        return this.signupAsShop(credentials).$promise;
      },
  ...
  function AdminService($resource) {
    ...
    angular.extend(Admin, {
      findAllGroups: function (params) {
        var modules = $resource('/api/groups', params);
        return modules.get({}).$promise;
      }
    });

    angular.extend(Admin, {
      findAllShops: function (params) {
