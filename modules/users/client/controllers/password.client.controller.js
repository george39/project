  ...
  function PasswordController(
    ...
    function onRequestPasswordResetSuccess(response) {
      ...
      Notification.success({
        ...
        title: '<i class="far fa-thumbs-up"></i> Password reset email sent successfully!'
      });
    }
    ...
    function onRequestPasswordResetError(response) {
      ...
      Notification.warning({
        ...
        title: '<i class="fas fa-trash-alt"></i> Failed to send password reset email!',
        delay: 4000
      });
    }
    ...
    function onResetPasswordSuccess(response) {
      ...
      Notification.success({
        message: '<i class="far fa-thumbs-up"></i> Password reset successful!'
      });
    ...
    function onResetPasswordError(response) {
      Notification.warning({
        message: response.data.message,
        title: '<i class="fas fa-trash-alt"></i> Password reset failed!',
        delay: 4000
      });
    }
  }
