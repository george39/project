  ...
  function menuService() {
    ...
    function init() {
      ...
      shouldRender = function (user) {
        ...
        if (this.module && this.module.length > 0 && user.group.option) {
          // var matchingModules = Object.keys(user.group.option).filter(function (userModule) {
          //   return this.module.indexOf(userModule) !== -1;
          // }, this);
          var count = 0;

          angular.forEach(this.module, function (_module) {
            if (user.group.option[_module]) {
              if (user.group.option[_module].module === true) {
                count++;
              }
            }
          });
        ...
        // if (this.items && this.items.length > 0 && user.group.option) {
        //   var matchingItemsModules;
        //   var itemsModules = this.items;
        //   var cont = 0;
        //   for (var index = 0; index < itemsModules.length; index++) {
        //     // eslint-disable-next-line no-loop-func
        //     matchingItemsModules = Object.keys(user.group.option).filter(function (userModule) {
        //       return itemsModules[index].module.indexOf(userModule) !== -1;
        //     }, this);
        //     if (matchingItemsModules.length > 0) {
        //       cont += 1;
        //     }
        //   }
        //   if (cont > 0) {
