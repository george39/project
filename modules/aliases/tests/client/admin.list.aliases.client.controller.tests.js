(function () {
  ...
  describe('Admin Aliases List Controller Tests', function () {
    // Initialize global variables
    var AliasesAdminListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      $httpBackend
        .whenGET('/modules/aliases/client/views/list-aliases.client.view.html')
        .respond(200, '');
      ...
      AliasesAdminListController = $controller('AliasesAdminListController as vm', {
        $scope: $scope
      });
