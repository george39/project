(function () {
  ...
  describe('Admin Notifications List Controller Tests', function () {
    // Initialize global variables
    var NotificationsAdminListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      $httpBackend
        .whenGET('/modules/notifications/client/views/list-notifications.client.view.html')
        .respond(200, '');
      ...
      NotificationsAdminListController = $controller('NotificationsAdminListController as vm', {
        $scope: $scope
      });
