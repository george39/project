(function () {
  ...
  describe('ManagerFiles List Controller Tests', function () {
    // Initialize global variables
    var ManagerFilesListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      ManagerFilesListController = $controller('ManagerFilesListController as vm', {
        $scope: $scope
      });
