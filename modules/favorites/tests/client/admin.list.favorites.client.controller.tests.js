(function () {
  ...
  describe('Admin Favorites List Controller Tests', function () {
    // Initialize global variables
    var FavoritesAdminListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      $httpBackend
        .whenGET('/modules/favorites/client/views/list-favorites.client.view.html')
        .respond(200, '');
      ...
      FavoritesAdminListController = $controller('FavoritesAdminListController as vm', {
        $scope: $scope
      });
