(function () {
  ...
  describe('Admin Movements List Controller Tests', function () {
    // Initialize global variables
    var MovementsAdminListController;
    var $scope;
    var $httpBackend;
    var $state;
    var Authentication;
    ...
    beforeEach(inject(function (
      ...
      $httpBackend
        .whenGET('/modules/movements/client/views/list-movements.client.view.html')
        .respond(200, '');
      ...
      MovementsAdminListController = $controller('MovementsAdminListController as vm', {
        $scope: $scope
      });
