...
describe('Product CRUD tests', function () {
  ...
  it('should be able to get a list of products if not signed in', function (done) {
    ...
    productObj.save(function () {
      // Request products
      agent.get('/api/products').end(function (req, res) {
        // Set assertion
  ...
  it('should be able to get a single product if not signed in', function (done) {
    ...
    // Save the product
    productObj.save(function () {
      agent.get('/api/products/' + productObj._id).end(function (req, res) {
        // Set assertion
  ...
  it('should return proper error for single product with an invalid Id, if not signed in', function (done) {
    ...
    agent.get('/api/products/test').end(function (req, res) {
      // Set assertion
  ...
  it('should return proper error for single product which doesnt exist, if not signed in', function (done) {
    ...
    agent.get('/api/products/559e9cd815f80b4c256a8f41').end(function (req, res) {
      // Set assertion
      res.body.should.be
        .instanceof(Object)
        .and.have.property('message', 'No product with that identifier has been found');
              ...
              orphan.remove(function () {
                ...
                agent
                  ...
                  .end(function (err, res) {
                    ...
                    // Get the product
                    agent
                      .get('/api/products/' + productSaveRes.body._id)
                      .expect(200)
