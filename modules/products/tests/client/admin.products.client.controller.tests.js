  ...
  describe('Products Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (
        ...
        // Set POST response
        $httpBackend
          .expectPOST('/api/products', sampleProductPostData)
          .respond(mockProduct);
        ...
        expect(Notification.success).toHaveBeenCalledWith({
          message: '<i class="fas fa-check"></i> Product saved successfully!'
        });
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({
          message: errorMessage,
          title: '<i class="fas fa-trash-alt"></i> Product save error!'
        });
      });
    });
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the product and redirect to products', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({
          message: '<i class="fas fa-check"></i> Product deleted successfully!'
        });
        expect($state.go).toHaveBeenCalledWith('admin.products.list');
      });
