...
var validateSecureMode = function (config) {
  ...
  if (!privateKey || !certificate) {
    ...
    console.log(
      chalk.red('  To create them, simply run the following from your shell: sh ./scripts/generate-ssl-certs.sh')
    );
    console.log();
...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.client.css = getGlobbedPaths(assets.client.lib.css, 'public/').concat(
    getGlobbedPaths(assets.client.css, ['public/'])
  );
